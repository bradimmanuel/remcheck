...
if ( $Consultant == "All CRC" ) {
	...
	$ConsultantStringEnd = '' ;
	$ConsultantName = '(\'Assigned Group*+\' = "HR Computer Support" OR \'Assigned Group*+\' = "ITS * CSLI" OR \'Assigned Group*+\' = "ITS * EPGY" OR \'Assigned Group*+\' = "ITS * Earth Sciences"  OR \'Assigned Group*+\' = "ITS * HEPL" OR \'Assigned Group*+\' = "ITS * IT Services" OR \'Assigned Group*+\' = "ITS * Orthopaedic Surgery" OR \'Assigned Group*+\' = "ITS * Pain Management Center" OR \'Assigned Group*+\' = "ITS * Procurement" OR \'Assigned Group*+\' = "ITS * Research Compliance" OR \'Assigned Group*+\' = "ITS * Vaden Health" OR \'Assigned Group*+\' = "ITS * Y2E2" OR \'Assigned Group*+\' = "ITS * GLAM" OR \'Assigned Group*+\' = "ITS * Dean of Research" OR \'Assigned Group*+\' = "ITS * Athletics" OR \'Assigned Group*+\' = "ITS * CFO" OR \'Assigned Group*+\' = "ITS * Internal Audit" OR \'Assigned Group*+\' = "ITS * Nanofabrication" OR \'Assigned Group*+\' = "ITS * XST" OR \'Assigned Group*+\' = "ITS * OPA" OR \'Assigned Group*+\' = "ITS * Research Admin" OR \'Assigned Group*+\' = "ITS * RiceHadley" OR \'Assigned Group*+\' = "ITS * Stanford Center on Longevity" OR \'Assigned Group*+\' = "ITS * UGA" OR \'Assigned Group*+\' = "ITS * Woods Institute" OR \'Assigned Group*+\' = "ITS * Global Climate" OR \'Assigned Group*+\' = "ITS * OOD" OR \'Assigned Group*+\' = "ITS * H&S" OR \'Assigned Group*+\' = "ITS * General Counsel" OR \'Assigned Group*+\' = "ITS * GSB" OR \'Assigned Group*+\' = "ITS * H&S CrashPlan") AND NOT (\'Assignee+\' = "Fred Broome" OR \'Assignee+\' = "Jamie Martinez" OR \'Assignee+\' = "Julie Reynolds-Grabbe" OR \'Assignee+\' = "Jennifer Honciano")AND NOT (\'Status*\' = "Cancelled")';
	...
	$ConsultantStringStart = ' AND ' ;
	$ConsultantStringEnd = '' ;
	$ConsultantName = '(\'Assignee+\' = "Karen Zack" OR \'Assignee+\' = "Jimmy Nguyen" OR \'Assignee+\' = "Gene Ren" OR \'Assignee+\' = "Todd Boyden" OR \'Assignee+\' = "Jimmy Nguyen")' ;
	$ConsultantNameProse = "XST" ;
	
} elseif ($Consultant == "Badgers") {
	$ConsultantStringStart = ' AND ' ;
	$ConsultantStringEnd = '' ;
	$ConsultantName = '(\'Assigned Group*+\' = "ITS * GLAM" OR \'Assigned Group*+\' = "ITS * Dean of Research" OR \'Assigned Group*+\' = "ITS * Athletics" OR \'Assigned Group*+\' = "ITS * CFO" OR \'Assigned Group*+\' = "ITS * Internal Audit" OR \'Assigned Group*+\' = "ITS * Nanofabrication" OR \'Assigned Group*+\' = "ITS * OPA" OR \'Assigned Group*+\' = "ITS * Research Admin" OR \'Assigned Group*+\' = "ITS * RiceHadley" OR \'Assigned Group*+\' = "ITS * Stanford Center on Longevity" OR \'Assigned Group*+\' = "ITS * UGA" OR \'Assigned Group*+\' = "ITS * Woods Institute" OR \'Assigned Group*+\' = "ITS * Global Climate" OR \'Assigned Group*+\' = "HR Computer Support" OR \'Assigned Group*+\' = "ITS * OOD" OR \'Assigned Group*+\' = "ITS * CSLI" OR \'Assigned Group*+\' = "ITS * EPGY" OR \'Assigned Group*+\' = "ITS * Earth Sciences"  OR \'Assigned Group*+\' = "ITS * HEPL" OR \'Assigned Group*+\' = "ITS * IT Services" OR \'Assigned Group*+\' = "ITS * Procurement" OR \'Assigned Group*+\' = "ITS * Research Compliance") AND NOT ( \'Assignee+\' = "Fred Broome" OR \'Assignee+\' = "Jamie Martinez" OR \'Assignee+\' = "Julie Reynolds-Grabbe" OR \'Assignee+\' = "Jennifer Honciano") AND NOT (\'Status*\' = "Cancelled")' ;
	$ConsultantNameProse = "Badgers" ;
#Bio-x Removed due to not tracking remedy tickets OR \'Assigned Group*+\' = "ITS * Bio-X" 
} elseif ($Consultant == "IT Sharks") {
	$ConsultantStringStart = ' AND ' ;
	$ConsultantStringEnd = '' ;
	$ConsultantName = '(\'Assigned Group*+\' = "ITS * H&S" OR \'Assigned Group*+\' = "ITS * General Counsel" OR \'Assigned Group*+\' = "ITS * H&S CrashPlan" OR \'Assigned Group*+\' = "ITS * Orthopaedic Surgery" OR \'Assigned Group*+\' = "ITS * Pain Management Center" OR \'Assigned Group*+\' = "ITS * Vaden Health" OR \'Assigned Group*+\' = "ITS * GSB" OR \'Assigned Group*+\' = "ITS * Y2E2") AND NOT (\'Assignee+\' = "Fred Broome" OR \'Assignee+\' = "Jamie Martinez" OR \'Assignee+\' = "Julie Reynolds-Grabbe" OR \'Assignee+\' = "Jennifer Honciano") AND NOT (\'Status*\' = "Cancelled")' ;
	$ConsultantNameProse = "IT Sharks" ;
} elseif ( $Consultant == "Server Team" ) {
	$ConsultantStringStart = ' AND ' ;
	$ConsultantStringEnd = '' ;
	$ConsultantName = '(\'Assigned Group*+\' = "ITS * CRC Server Group") AND NOT (\'Status*\' = "Cancelled")';
