...
#Bio-x Removed due to not tracking remedy tickets OR \'Assigned Group*+\' = "ITS * Bio-X" 
	...
	$ConsultantStringStart = ' AND ' ;
	$ConsultantStringEnd = '' ;
	$ConsultantName = '(\'Assigned Group*+\' = "ITS * H&S" OR \'Assigned Group*+\' = "ITS * General Counsel" OR \'Assigned Group*+\' = "ITS * H&S CrashPlan" OR \'Assigned Group*+\' = "ITS * Orthopaedic Surgery" OR \'Assigned Group*+\' = "ITS * Pain Management Center" OR \'Assigned Group*+\' = "ITS * Vaden Health" OR \'Assigned Group*+\' = "ITS * Y2E2") AND NOT (\'Assignee+\' = "Jamie Martinez" OR \'Assignee+\' = "Julie Reynolds-Grabbe" OR \'Assignee+\' = "Jennifer Honciano")' ;
